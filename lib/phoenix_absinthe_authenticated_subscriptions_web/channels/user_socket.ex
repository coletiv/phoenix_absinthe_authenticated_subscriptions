defmodule PhoenixAbsintheAuthenticatedSubscriptionsWeb.UserSocket do
  @moduledoc false
  ...
  ## Channels
  # channel "room:*", PhoenixAbsintheAuthenticatedSubscriptionsWeb.RoomChannel
  ...
  #
  #     PhoenixAbsintheAuthenticatedSubscriptionsWeb.Endpoint.broadcast("user_socket:#{user.id}", "disconnect", %{})
  #
